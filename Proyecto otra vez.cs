            ...
            static void IncluirEstudiantes()
            {
                for (int i = 0; i < estudiantes.Length; i++)
                {
                    if (estudiantes[i] == null)
                    {
                        ...
                        {
                            Console.WriteLine("Error de formato en la cédula. Por favor, ingrese un formato válido.");
                        }
                        ...
                        {
                            Console.WriteLine("Error de formato en el nombre. Por favor, ingrese un formato válido.");
                        }
                        try
                        {
                            string condicion;
